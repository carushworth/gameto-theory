...
meiosisGFcomplex <- function(this.dip, tmp.haplo.names, r12,r23, this.order = "MAF") {
...
runGFsim <-function(n.gen = Inf, r12 = 1e-4, r23 = 1e-4, 
                           init.freqs = c(fA_0 = 0, fM_0 = 0, fF_0 = 0,fA_1 = 1, fM_1 = 1, fF_1 = .01), 
                           discrim = 1, s = 0.75, tol = 1e-6, max.gen = 2e6, min.gen = 1e3,
                           prop.replaced0 = .1, 
                           prop.replaced1 = .1,
                           this.order = "AMF",
                           n.unlinked =0,
...
output  <- runGFsim(this.order = "MFA", #n.gen = n.gen,  
  discrim = 1,
  s   =  0.75,
  r12 =  1e-4,
  r23 =  1e-4,
  ...
  n.unlinked     = 0,
  delta_hap_components = TRUE)
save(output, file=paste("out",paste(paste("s",0.75,"m0m1",0.1,"r123",1e-4,"M",1),"n.unl",0,collapse="_"),".Robj",sep=""))
write.table(c(output$summary.stats,output$params),file=paste("out",paste(paste("s",0.75,"m0m1",0.1,"r123",1e-4,"M",1),"n.unl",0,collapse="_"),".txt",sep=""))
